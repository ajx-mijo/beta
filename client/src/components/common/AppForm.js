...
import AddSectorDropdown from '../../helpers/AddSectorDropdown'
import AddToolDropdown from '../../helpers/AddToolDropdown'
      ...
      <div id="location-form" className="form-container">
        <form onSubmit={handleSubmit}>
          ...
          <div className='form-fields'>
            ...
            <div className='form-fields'>
              <AddToolDropdown setFormFields={setFormFields} />
            </div>
          ...
          <div className='form-fields'>
            ...
            <div className='form-fields'>
              <AddSectorDropdown setFormFields={setFormFields} />
            </div>
